...
void lcd_print_value(int16_t value_x10, uint8_t row, uint8_t col);

uint8_t sht45_start_measurement(void);
uint8_t sht45_read_data(uint16_t *temp_raw, uint16_t *rh_raw);
int16_t sht45_calc_temp_x10(uint16_t raw);
int16_t sht45_calc_rh_x10(uint16_t raw);
...
int main(void) {
    ...
    int16_t temp_x10, rh_x10;

    while(1) {
        if (sht45_start_measurement() && sht45_read_data(&temp_raw, &rh_raw)) {
            temp_x10 = sht45_calc_temp_x10(temp_raw);
            rh_x10 = sht45_calc_rh_x10(rh_raw);
...
void lcd_print_value(int16_t value_x10, uint8_t row, uint8_t col) {
    ...
    int16_t integer = value_x10 / 10;
    uint8_t fraction = value_x10 % 10;
...
uint8_t sht45_start_measurement(void) {
    ...
    if (!i2c_write_byte_on(SHT45_I2C_PORT, 0xFD)) {
...
int16_t sht45_calc_temp_x10(uint16_t raw) {
    return (int16_t)(-450 + (1750LL * raw) / 65535);
}

int16_t sht45_calc_rh_x10(uint16_t raw) {
    return (int16_t)(-60 + (1250LL * raw) / 65535);
}
